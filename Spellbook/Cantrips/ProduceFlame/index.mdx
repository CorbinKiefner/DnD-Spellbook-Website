...
feet. The spell ends if you dismiss it as an action or if you cast it again.
...
levelinfo: "At Higher Levels. This spell’s damage increases by 1d8 when you 
reach 5th level (2d8), 11th level (3d8), and 17th level (4d8)."

hero_image: "Spellbook/Cantrips/ProduceFlame/conjuration.png"

hero_image_alt: "Conjuration Magic"

---
You create a small flame in your hand that you can use as a light source or weapon, potentially setting things alight.