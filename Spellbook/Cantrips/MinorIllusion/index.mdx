...
lasts for the duration. The illusion also ends if you dismiss it as an action 
...
or any other sound you choose. The sound continues unabated throughout the 
...
or a small chest—it must be no larger than a 5-foot cube. The image can’t 
create sound, light, smell, or any other sensory effect. Physical interaction 
...
hero_image: "Spellbook/Cantrips/MinorIllusion/illusion.png"

hero_image_alt: "Illusion Magic"

---
You create a minor visual or auditory illusion that can deceive or distract.